  ...
  return (
    <div>
      ...
      <p className={styles.text}>
        ...
        urna, dapibus eget mollis sit amet, rutrum nec dui. Phasellus volutpat,
        ante eget elementum efficitur, ante lacus viverra massa, sodales
        eleifend ligula arcu eu odio.
      </p>
      <p className={styles.text}>
        Lorem ipsum dolor sit amet, consectetur adipiscing elit. Proin aliquam
        dapibus lacus, vel porta mi consequat sit amet. Pellentesque accumsan
